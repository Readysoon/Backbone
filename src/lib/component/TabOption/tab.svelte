<script lang="ts">
	...
	const handleTableOptionUpdate = (selectedObj: string) => {
		dispath('optionUpdate', selectedObj);
	};
</script>
...
<style>
	...
	.navBox {
		/* background-color: #22c4e47e; */
		background-color: #000000a7;
		width: 20%;
		height: 60%;
		border-radius: 50px;
		/* border: 2px solid #22c4e4a9; */
